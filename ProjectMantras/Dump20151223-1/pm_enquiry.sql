...
CREATE TABLE `enquiry` (
  ...
  `EnquiryInternship` varchar(45) NOT NULL DEFAULT 'No',
  `EnquiryProject` varchar(45) NOT NULL DEFAULT 'No',
  `EnquiryTraining` varchar(45) NOT NULL DEFAULT 'No',
  `DateOfEnquiry` varchar(45) NOT NULL,
